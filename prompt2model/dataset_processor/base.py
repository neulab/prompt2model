...
class BaseProcessor(ABC):
    ...
    def process_generated_and_retrieved_datasets(
        self,
        instruction: str,
        generated_dataset: datasets.Dataset,
        retrieved_dataset: datasets.Dataset,
        train_proportion: float = 0.8,
        val_proportion: float = 0.1,
        ...
        Args:
            instruction: The instruction used as a prefix to explain the task.
            generated_dataset: Dataset generated by DatasetGenerator.
            retrieved_dataset: Dataset retrieved by DatasetRetriever.
        ...
        dataset_dicts = [
            ...
            for each in [generated_dataset, retrieved_dataset]
        ]
