    ...
    def retrieve(
        ...
        if self.use_bm25:
            ...
            for result in results:
                model_description = self.model_metadata[result["id"]]["description"]
                model_info = ModelInfo(result["id"], model_description)
                ranked_model_list.append(ModelScorePair(model_info, result["score"]))
        else:
